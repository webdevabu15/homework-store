  ...
  return (
    <div className='create'>
      <form className='create-form' onSubmit={handleCreatePost}>
        <input type="text" placeholder='Title' value={title} onChange={(e) => setTitle(e.target.value)} className='form__input' />
        <input type="url" placeholder="img" className="form__input" value={image} onChange={(e) => setImage(e.target.value)}/>
